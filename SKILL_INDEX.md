...
| Conductor | `conductor` | Routing and orchestration layer | Project orientation, multi-skill routing, workflow planning, access/visibility routing | A single obvious specialist suffices | Commander | None | Routing Plan, Prompts |
...
| Overseer | `overseer` | Quality assurance auditor and release gatekeeper | Test strategy, test cases, defect triage, regression, release readiness, persona validation | Destructive pressure testing is needed | Specialist | None | Caveman, Full QA Review |
| Cipher | `cipher` | Security and privacy auditor | Defensive review, RBAC, data protection, sensitive data handling, visibility/access-control | Offensive or destructive testing is needed | Specialist | None | Caveman, Full Security Review |
